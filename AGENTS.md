...
-   **E2E Tests:** Any changes that affect the UI **must** be accompanied by E2E tests to prevent regressions. Use the Playwright test suite in `tests_e2e/` to verify the application's behavior from a user's perspective.
